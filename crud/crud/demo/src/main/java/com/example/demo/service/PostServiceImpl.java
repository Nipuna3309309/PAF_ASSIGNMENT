...
public class PostServiceImpl implements PostService {
    ...
    @Override
    public Post createPost(String description, MultipartFile[] mediaFiles, boolean isVideo)
    ...
    @Override
    public Post updatePost(String id, String description, MultipartFile[] mediaFiles, boolean isVideo) throws IOException {
        ...
        // Optional: Delete old media files if new ones are uploaded
